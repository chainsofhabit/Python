# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-11-08 08:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('WAIT_BUYER_PAY', '交易创建'), ('paying', '待支付'), ('TRADE_CLOSE', '交易关闭'), ('TRADE_SUCCESS', '成功'), ('TRADE_FINISHED', '交易结束')], default='paying', max_length=20, verbose_name='交易状态')),
