...
#作业：
#正向查询：通过学生查找班级
@blue.route('/select_gda/',methods=['GET'])
def select_gda():
    #通过学生查询班级
    stu = Student.query.filter(Student.s_name=='大傻子').first()
    # 学生对象backref
    grade = stu.g
    return '查询成功'
    # return render_template('base.html',grade=grade,stu=stu)
#反向查询：通过班级查找学生
...
def select_stu():
    ...
    stus = grade.student
    return '查询成功'
    # return render_template('students.html',stus=stus,grade=grade)
